...
C$$$
     ...
     &       kpds(16).eq.10) .AND.
     &      (((kpds(5).eq.33 .OR. kpds(5).eq.34 .OR. 
     &       kpds(5).eq.5) .AND. kpds(6).eq. 6) .OR.
     ...
     &      kpds(5).eq.172) ipdstmpl(24)=0          ! for Mean Icing, CT, CAT
          if (kpds(5).eq.169.or.kpds(5).eq.171.or.   ! statistical process WAFS-ICAO
     &      kpds(5).eq.173) ipdstmpl(24)=2          ! for MAX Icing, CT, CAT
