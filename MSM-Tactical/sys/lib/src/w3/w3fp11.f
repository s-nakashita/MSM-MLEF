...
C   05-05-12  VUONG       ADD FOUR LEVELS (235,236,237,238) AND ADDED 15
C                         NEW PARAMETERS TO TABLE VERSION 129 AND ADDED 
C                         ONE PARAMETER 154 TO TABLE VERSION 130 AND
C                         CHANGES FOR O.N. 388   MAY 11, 2005
C
...
C
     ...
     &               152, 153, 154, 155, 170, 171, 172,
     &               173, 180, 181, 182, 183, 190, 191,
     &               195, 196, 197, 198, 199, 200, 201,
     &               202, 210, 211, 212/
        DATA  HHNAM129/
     &' PAOT ',' PAOP ',' FRAIN',' FICE ',' FRIME',' CUEFI',' TCOND',
     &' TCOLW',' TCOLI',' TCOLR',' TCOLS',' TCOLC',' PLPL ',' HLPL ',
     &' CEMS ',' COPD ',' PSIZ ',' TCWAT',' TCICE',' PTAN ',' PTNN ',
     &' PTBN ',' PPAN ',' PPNN ',' PPBN ',' ELRDI',' TSEC ',' TSECA',
     &' NUM  ',' OZCON',' OZCAT',' VEDH ',' SIGV ',' USCT ',' VSCT ',
     &' DBSS ',' ODHA ',' OHC  ',' SSHG ',' SLTFL',' DUVB ',' CDUVB',
     &' THFLX',' REFO ',' RAFD ',' REFC '/
C
...
C       NUMBER 1 OR 2 OR 129 OR 130 OR 131
C
