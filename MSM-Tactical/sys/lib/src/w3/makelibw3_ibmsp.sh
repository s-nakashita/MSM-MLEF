...
export FFLAGS=" -O3 -qnosave -qmoddir=../../incmod/w3_4"
export AFLAGS=" -X64"
...
export FFLAGS=" -O3 -qnosave -qintsize=8 -qrealsize=8 -qmoddir=../../incmod/w3_8"
export AFLAGS=" -X64"
export CFLAGS=" -O3 -q64"
make -f make.libw3
#
...
export FFLAGS=" -O3 -qnosave -qrealsize=8 -qmoddir=../../incmod/w3_d"
export AFLAGS=" -X64"
export CFLAGS=" -O3 -q64"
make -f make.libw3
