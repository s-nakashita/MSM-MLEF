! Description:
!> @file
!!   Compute optical parameters for ice cloud from Baran 2018 parameterisation
!
!> @brief
!!   Compute optical parameters for ice cloud from Baran 2018 parameterisation
!!
...
!
SUBROUTINE rttov_baran2018_calc_optpar (optp, ichn, t_in, iwc_in, abso, sca, bpr, asym)
...
!    ENDIF
    ...
    if (asym > baran2018_max_asym) asym = baran2018_max_asym
