...
! Only options which affect calculation results are compared (e.g. not verbose)
  rttov_opts_eq = &
   ...
   ( opts1%config%opdep13_gas_clip        .EQV. opts2%config%opdep13_gas_clip        ) .AND. &
   ...
   ( opts1%rt_all%use_tskin_eff           .EQV. opts2%rt_all%use_tskin_eff           ) .AND. &
   ...
   ( opts1%rt_all%transmittances_only     .EQV. opts2%rt_all%transmittances_only     ) .AND. &
   ...
   ( opts1%rt_ir%rayleigh_depol           .EQV. opts2%rt_ir%rayleigh_depol           ) .AND. &
   ...
   ( opts1%rt_mw%fastem3_rwd_fix          .EQV. opts2%rt_mw%fastem3_rwd_fix          ) .AND. &
