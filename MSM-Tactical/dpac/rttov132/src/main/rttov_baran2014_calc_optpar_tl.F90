! Description:
!> @file
!!   TL of optical parameters for ice cloud from Baran 2014 parameterisation
!
!> @brief
!!   TL of optical parameters for ice cloud from Baran 2014 parameterisation
!!
...
!- End of header --------------------------------------------------------
    ...
    absi_tl =  &
         & baran2014_regcoef_abs(2_jpim,iwn)*T_tl + &
         & baran2014_regcoef_abs(3_jpim,iwn)*LIWC_tl + &
         & baran2014_regcoef_abs(4_jpim,iwn)*2.0_jprb*T*T_tl + &
         & baran2014_regcoef_abs(5_jpim,iwn)*2.0_jprb*LIWC*LIWC_tl + &
         & baran2014_regcoef_abs(6_jpim,iwn)*(T*LIWC_tl + T_tl*LIWC )
    ...
    absj_tl =  &
         & baran2014_regcoef_abs(2_jpim,jwn)*T_tl + &
         & baran2014_regcoef_abs(3_jpim,jwn)*LIWC_tl + &
         & baran2014_regcoef_abs(4_jpim,jwn)*2.0_jprb*T*T_tl + &
         & baran2014_regcoef_abs(5_jpim,jwn)*2.0_jprb*LIWC*LIWC_tl + &
         & baran2014_regcoef_abs(6_jpim,jwn)*(T*LIWC_tl + T_tl*LIWC )
    ...
    scai_tl =  &
         & baran2014_regcoef_sca(2_jpim,iwn)*T_tl + &
         & baran2014_regcoef_sca(3_jpim,iwn)*LIWC_tl + &
         & baran2014_regcoef_sca(4_jpim,iwn)*2.0_jprb*T*T_tl + &
         & baran2014_regcoef_sca(5_jpim,iwn)*2.0_jprb*LIWC*LIWC_tl + &
         & baran2014_regcoef_sca(6_jpim,iwn)*(T*LIWC_tl + T_tl*LIWC )
    ...
    scaj_tl =  &
         & baran2014_regcoef_sca(2_jpim,jwn)*T_tl + &
         & baran2014_regcoef_sca(3_jpim,jwn)*LIWC_tl + &
         & baran2014_regcoef_sca(4_jpim,jwn)*2.0_jprb*T*T_tl + &
         & baran2014_regcoef_sca(5_jpim,jwn)*2.0_jprb*LIWC*LIWC_tl + &
         & baran2014_regcoef_sca(6_jpim,jwn)*(T*LIWC_tl + T_tl*LIWC )
    ...
    bpri_tl =  &
         & baran2014_regcoef_bpr(2_jpim,iwn)*T_tl + &
         & baran2014_regcoef_bpr(3_jpim,iwn)*LIWC_tl
    bprj = baran2014_regcoef_bpr(1_jpim,jwn)    + &
         & baran2014_regcoef_bpr(2_jpim,jwn)*T + &
         & baran2014_regcoef_bpr(3_jpim,jwn)*LIWC
    bprj_tl =  &
         & baran2014_regcoef_bpr(2_jpim,jwn)*T_tl + &
         & baran2014_regcoef_bpr(3_jpim,jwn)*LIWC_tl
