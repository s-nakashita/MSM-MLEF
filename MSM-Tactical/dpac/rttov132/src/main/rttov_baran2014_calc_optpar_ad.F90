! Description:
!> @file
!!   AD of optical parameters for ice cloud from Baran 2014 parameterisation
!
!> @brief
!!   AD of optical parameters for ice cloud from Baran 2014 parameterisation
!!
...
!INTF_END
  ...
  REAL(KIND=jprb)  :: absi, absj, bpr, bpri, bprj
...
! ASYM
    ...
    if (asym > baran2014_max_asym) then
      asym_ad = 0.0_jprb
    endif
    ...
    T_ad =     T_ad    + baran2014_regcoef_asym(2_jpim,iwn)*asymi_ad
    LIWC_ad =  LIWC_ad + baran2014_regcoef_asym(3_jpim,iwn)*asymi_ad
    asymi_ad = 0.0_jprb
    T_ad =     T_ad    + baran2014_regcoef_asym(2_jpim,jwn)*asymj_ad
    LIWC_ad =  LIWC_ad + baran2014_regcoef_asym(3_jpim,jwn)*asymj_ad
    asymj_ad = 0.0_jprb
...
! BPR
    ...
    T_ad =     T_ad    + baran2014_regcoef_bpr(2_jpim,iwn)*bpri_ad
    LIWC_ad =  LIWC_ad + baran2014_regcoef_bpr(3_jpim,iwn)*bpri_ad
    bpri_ad = 0.0_jprb
    T_ad =     T_ad    + baran2014_regcoef_bpr(2_jpim,jwn)*bprj_ad
    LIWC_ad =  LIWC_ad + baran2014_regcoef_bpr(3_jpim,jwn)*bprj_ad
    bprj_ad = 0.0_jprb
...
! SCA
    ...
    T_ad =     T_ad    + (baran2014_regcoef_sca(2_jpim,iwn) + 2.0_jprb*baran2014_regcoef_sca(4_jpim,iwn)*T + &
                          baran2014_regcoef_sca(6_jpim,iwn)*LIWC)*scai_ad
    LIWC_ad =  LIWC_ad + (baran2014_regcoef_sca(3_jpim,iwn) + 2.0_jprb*baran2014_regcoef_sca(5_jpim,iwn)*LIWC + &
                          baran2014_regcoef_sca(6_jpim,iwn)*T)*scai_ad
    scai_ad = 0.0_jprb
    T_ad =     T_ad    + (baran2014_regcoef_sca(2_jpim,jwn) + 2.0_jprb*baran2014_regcoef_sca(4_jpim,jwn)*T + &
                          baran2014_regcoef_sca(6_jpim,jwn)*LIWC)*scaj_ad
    LIWC_ad =  LIWC_ad + (baran2014_regcoef_sca(3_jpim,jwn) + 2.0_jprb*baran2014_regcoef_sca(5_jpim,jwn)*LIWC + &
                          baran2014_regcoef_sca(6_jpim,jwn)*T)*scaj_ad
    scaj_ad = 0.0_jprb
...
! ABS
    ...
    T_ad =     T_ad    + (baran2014_regcoef_abs(2_jpim,iwn) + 2.0_jprb*baran2014_regcoef_abs(4_jpim,iwn)*T + &
                          baran2014_regcoef_abs(6_jpim,iwn)*LIWC)*absi_ad
    LIWC_ad =  LIWC_ad + (baran2014_regcoef_abs(3_jpim,iwn) + 2.0_jprb*baran2014_regcoef_abs(5_jpim,iwn)*LIWC + &
                          baran2014_regcoef_abs(6_jpim,iwn)*T)*absi_ad
    absi_ad = 0.0_jprb
    T_ad =     T_ad    + (baran2014_regcoef_abs(2_jpim,jwn) + 2.0_jprb*baran2014_regcoef_abs(4_jpim,jwn)*T + &
                          baran2014_regcoef_abs(6_jpim,jwn)*LIWC)*absj_ad
    LIWC_ad =  LIWC_ad + (baran2014_regcoef_abs(3_jpim,jwn) + 2.0_jprb*baran2014_regcoef_abs(5_jpim,jwn)*LIWC + &
                          baran2014_regcoef_abs(6_jpim,jwn)*T)*absj_ad
    absj_ad = 0.0_jprb
