...
!  INTEGER, PUBLIC, PARAMETER  :: fp = SELECTED_REAL_KIND(15)
  ...
  REAL( fp ), PUBLIC, PARAMETER ::  min_f = 1.4_fp           !< Minimum frequency
  REAL( fp ), PUBLIC, PARAMETER ::  max_f = 200.0_fp         !< Maximuim frequency

  REAL( fp ), PUBLIC, PARAMETER ::  min_wind = 0.3_fp        !< Minimuim wind speed
  REAL( fp ), PUBLIC, PARAMETER ::  max_wind = 35.0_fp       !< Maximuim wind speed
