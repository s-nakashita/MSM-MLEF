...
!--------------------------
    IF (ASSOCIATED(fast_coef(chan)%mixedgas)) THEN
      ...
      IF (opdep13_gas_clip) WHERE (opdp_ref%od_mg_ref(:,j) < 0._jprb) od_tl = 0.
      odtot_tl = od_tl
...
!--------------------
    IF (ASSOCIATED(fast_coef(chan)%watervapour)) THEN
      ...
      IF (opdep13_gas_clip) WHERE (opdp_ref%od_wv_ref(:,j) < 0._jprb) od_tl = 0.
...
!-------------
    IF (coef%nozone > 0) THEN
      IF (ASSOCIATED(fast_coef(chan)%ozone)) THEN
        ...
        IF (opdep13_gas_clip) WHERE (opdp_ref%od_o3_ref(:,j) < 0._jprb) od_tl = 0.
        odtot_tl = odtot_tl + od_tl
...
!------------------------------
    IF (coef%nwvcont > 0) THEN
      IF (ASSOCIATED(fast_coef(chan)%wvcont)) THEN
        ...
        IF (opdep13_gas_clip) WHERE (opdp_ref%od_wvcont_ref(:,j) < 0._jprb) od_tl = 0.
        odtot_tl = odtot_tl + od_tl
      ENDIF
    ENDIF
...
!-----------
    IF (coef%nco2 > 0) THEN
      IF (ASSOCIATED(fast_coef(chan)%co2)) THEN
        ...
        IF (opdep13_gas_clip) WHERE (opdp_ref%od_co2_ref(:,j) < 0._jprb) od_tl = 0.
        odtot_tl = odtot_tl + od_tl
...
!-----------
    IF (coef%nn2o > 0) THEN
      IF (ASSOCIATED(fast_coef(chan)%n2o)) THEN
        ...
        IF (opdep13_gas_clip) WHERE (opdp_ref%od_n2o_ref(:,j) < 0._jprb) od_tl = 0.
        odtot_tl = odtot_tl + od_tl
...
!-----------
    IF (coef%nco > 0) THEN
      IF (ASSOCIATED(fast_coef(chan)%co)) THEN
        ...
        IF (opdep13_gas_clip) WHERE (opdp_ref%od_co_ref(:,j) < 0._jprb) od_tl = 0.
        odtot_tl = odtot_tl + od_tl
...
!-----------
    IF (coef%nch4 > 0) THEN
      IF (ASSOCIATED(fast_coef(chan)%ch4)) THEN
        ...
        IF (opdep13_gas_clip) WHERE (opdp_ref%od_ch4_ref(:,j) < 0._jprb) od_tl = 0.
        odtot_tl = odtot_tl + od_tl
...
!-----------
    IF (coef%nso2 > 0) THEN
      IF (ASSOCIATED(fast_coef(chan)%so2)) THEN
        ...
        IF (opdep13_gas_clip) WHERE (opdp_ref%od_so2_ref(:,j) < 0._jprb) od_tl = 0.
        odtot_tl = odtot_tl + od_tl
