...
#include "rttov_baran_calc_phase_tl.interface"
  ...
  LOGICAL(KIND=jplm) :: do_dom, do_chou_scaling, do_single_scatt, do_aer_or_ray_dom
        ...
        DO lay = 1, nlayers
          ...
          IF (do_dom_chan) THEN
            ...
            IF (do_rayleigh_dom .AND. solar(j) .AND. &
              ...
              legcoef(2) = ray_lcoef_2 * sca
              legcoef_tl(0) = 1._jprb * sca_tl
              legcoef_tl(2) = ray_lcoef_2 * sca_tl
            ENDIF
          ENDIF
              ...
              ELSE
                ...
                IF (do_single_scatt_chan .OR. do_dom_chan) THEN
                  ...
                  IF (do_dom_chan) THEN
                    ...
                    CALL phasefn_interp_tl(thisnphangle, thiscosphangle(thisnphangle:1:-1), &
