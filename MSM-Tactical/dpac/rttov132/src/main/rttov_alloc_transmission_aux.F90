...
#include "rttov_init_transmission_aux.interface"
  ...
  LOGICAL(KIND=jplm) :: do_dom_ir, do_dom_vis, do_single_scatt, do_mfasis, do_mfasis_lut, do_mfasis_nn
!- End of header --------------------------------------------------------
  ...
  do_mfasis_lut = do_scatt .AND. opts%rt_ir%vis_scatt_model == vis_scatt_mfasis
  do_mfasis_nn = do_scatt .AND. opts%rt_ir%vis_scatt_model == vis_scatt_mfasis_nn
