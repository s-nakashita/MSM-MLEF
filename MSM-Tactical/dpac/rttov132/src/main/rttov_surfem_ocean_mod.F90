...
CONTAINS
  ...
  !! @param[out]    ev          calculated V-pol emissivity
  !! @param[out]    eh          calculated H-pol emissivity
  !! @param[out]    e3          calculated 3rd Stokes vector
  !! @param[out]    e4          calculated 4th Stokes vector
  SUBROUTINE rttov_surfem_ocean(f_GHz, theta, windspeed, SST, SSS, phi, ev, eh, e3, e4)
    ...
    CALL e_total(e_Nv, e_Nh, e_v0, e_h0, e_aniso, phi, ev, eh, e3, e4)
