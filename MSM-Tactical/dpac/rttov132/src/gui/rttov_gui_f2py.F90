...
SUBROUTINE RTTOV_GUI_LOAD( CHANNELS, FILE_COEF, FILE_SCAER, FILE_SCCLD, FILE_MFASIS_CLD  ,FILE_MFASIS_NN, FILE_PCCOEF, &
                           NCHANNELS, ERR )
!
#include "throw.h"
...
TRY
  ...
  IF( ASSOCIATED( THE_RTH ) ) THEN
    ...
    IF( TRIM( THE_RTH%FILE_MFASIS_NN ) .NE. "" ) &
      INFO(THE_RTH%FILE_MFASIS_NN)
  ...
  CALL RTTOV_GUI_HANDLELOAD(THE_RTH, CHANNELS, FILE_COEF, FILE_SCAER, FILE_SCCLD, FILE_MFASIS_CLD  ,FILE_MFASIS_NN, &
                            FILE_PCCOEF, ERR )
  THROW(ERR.NE.0)
