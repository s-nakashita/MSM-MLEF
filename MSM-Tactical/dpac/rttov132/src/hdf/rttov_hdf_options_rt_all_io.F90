...
sname='USE_TSKIN_EFF'
call read_array_hdf(lun,sname,err,l0=x%USE_TSKIN_EFF)
THROWM(err.ne.0,"CANNOT READ "//trim(sname))
...
sname='TRANSMITTANCES_ONLY'
call read_array_hdf(lun,sname,err,l0=x%TRANSMITTANCES_ONLY)
THROWM(err.ne.0,"CANNOT READ "//trim(sname))
...
sname='USE_TSKIN_EFF'
call write_array_hdf(lun,sname,&
  & 'Activate use of per-channel effective skin temperature inputs',&
  & err,l0=x%USE_TSKIN_EFF   )
THROWM(err.ne.0,"CANNOT WRITE "//trim(sname))
...
sname='TRANSMITTANCES_ONLY'
call write_array_hdf(lun,sname,&
  & 'Switch to only compute transmittances, no radiances',&
  & err,l0=x%TRANSMITTANCES_ONLY   )
THROWM(err.ne.0,"CANNOT WRITE "//trim(sname))
