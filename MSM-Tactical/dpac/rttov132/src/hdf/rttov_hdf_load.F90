...
!! @param         mfasisnn      MFASIS NN structure, optional
...
!
      ...
      TYPE(RTTOV_COEF_MFASIS_NN), OPTIONAL       :: MFASISNN
...
TRY
      ...
      ELSEIF( PRESENT(MFASISNN)) THEN

        CALL RTTOV_HDF_MFASISNNCOEF_RH(MFASISNN, G_ID,ERR)
        THROWM(ERR.NE.0,"CANNOT READ MFASIS CLD NN IN FILE "//TRIM(F))
