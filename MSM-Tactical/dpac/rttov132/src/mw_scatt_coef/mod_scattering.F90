...
!           08/09/2022   Allow 13.0 and 13.2 versions of hydrotables
...
real (kind=jprb)  , parameter :: t_ml = 277.0_jprb       ! T at bottom of melting layer in K
real (kind=jprb)  , parameter :: t_fl = 273.0_jprb      ! temperature at FL in k
...
integer (kind=jpim) :: wc_offset ! to be set in rttov_scatt_make_coef (temporarily)
integer (kind=jpim), parameter :: wc_offset_130 = 301
integer (kind=jpim), parameter :: wc_offset_132 = 401

integer (kind=jpim), parameter :: lversion = 4  !Exact length of version string
...
! Parameters for Rain PSDs
real (kind=jprb), parameter :: x1 = 0.22_jprb   ! from Abel and Boutle, 2012
real (kind=jprb), parameter :: x2 = 2.2_jprb    ! from Abel and Boutle, 2012

!* Hydro-tables
!*************
!*
integer (kind=jpim), parameter :: n_temp_130 = 70
integer (kind=jpim), parameter :: n_temp_132 = 100
integer (kind=jpim) :: n_temp ! to be set in rttov_scatt_make_coef (temporarily)
integer (kind=jpim), parameter :: n_lwc_130 = 401
integer (kind=jpim), parameter :: n_lwc_132 = 601
integer (kind=jpim)  :: n_lwc ! to be set in rttov_scatt_make_coef (temporarily)
...
integer (kind=jpim), parameter :: psd_abel_boutle     = 8
integer (kind=jpim), parameter :: psd_illingworth_blackman = 9
...
real    (kind=jprb) :: temp_offset_130(n_type) = (/ 233.0,   203.0,  203.0,  203.0,  233.0,   203.0,  203.0  /)
real    (kind=jprb) :: temp_offset    (n_type) = (/ 233.0,   177.0,  177.0,  177.0,  233.0,   177.0,  177.0  /)
