...
in Bauer (2001) but the current version is documented by Geer et al. (2021). This 
readme.txt is a short guide to running this utility and to the available options. 
...
A version specifier of either '13.0' or '13.2' is reguired in the channels.dat. All
version 13 hydrotables should be interoperable. The version 13.0 hydrotables remain
the default and recommended option, but version 13.2 is available for test purposes
and in particular to support improved radar reflectivity simulations. The v13.2 format 
makes the following changes:
   - Increased table range: 
       - now 100 rather than 70 temperatures, going from 177 - 277 K rather than 203 - 273 K 
         for frozen particles, and the liquid range from 233 K is extended to 333 K rather than 303 K  
       - now 501 rather than 401 liquid water contents, avoiding possible saturation of optical properties
         in intense and localised (e.g. small hydrometeor fraction) convection.
   - Small changes in the output format, including a reduction in precision from 16 to 8 decimal places
   - Only the v13.2 format supports the melting layer formulation (revised at v13.2) due to the need to
     provide temperature bins from 273 to 277 K in which to contain the melting optical properties.
...
7) McFarquhar and Heymsfield (1997)
8) Abel and Boutle (2012)
9) Illingworth and Blackman (2002)
...
Applicability: snow, graupel only

Implements a modified version of the melting layer of Bauer (2001). The main modification is to stretch
the melting layer over 5 temperature bins rather than one as in the original. The melting layer is a layer of 
enhanced scattering caused by water-coated frozen particles, and it is put in the 273 - 277 K  
temperature bins if active. Computations are always made using Mie spheres; other 
microphysical assumptions are also fixed and have been described in the paper. The original Bauer (2001) 
melting layer is deprecated, the new version is still under test. Use with caution. This can 
only be activated with the v13.2 output format (more temperature bins).
...
and the table generation will stop. Current renormalisation factors are appropriate to the default
PSDs and particle shapes; they may need to be adjusted for other combinations. However, large renormalisation
factors may be a sign of scientific problems. See Geer et al. (2021)
...
Geer, A.J., Bauer, P., Lonitz, K., Barlakas, V., Eriksson, P., Mendrok, J., Doherty, A., Hocking, J. and Chambon, P., 2021. Bulk hydrometeor optical properties for microwave and sub-millimetre radiative transfer in RTTOV-SCATT v13. 0. Geoscientific Model Development, 14(12), pp.7497-7526.

Barlakas, V, Geer AJ and Eriksson, P, 2021: Introducing hydrometeor orientation into all-sky microwave and submillimeter assimilation. Atmospheric Measurement Techniques, 14(5), pp.3427-3447.

Abel, S.J. and Boutle, I.A., 2012. An improved representation of the raindrop size distribution for single\u2010moment microphysics schemes. Quarterly Journal of the Royal Meteorological Society, 138(669), pp.2151-2162.

Illingworth, A. J., & Blackman, T. M. (2002). The Need to Represent Raindrop Size Spectra as Normalized Gamma Distributions for the Interpretation of Polarization Radar Observations, Journal of Applied Meteorology, 41(3), 286-297. Retrieved Sep 12, 2022, from https://journals.ametsoc.org/view/journals/apme/41/3/1520-0450_2002_041_0286_tntrrs_2.0.co_2.xml
