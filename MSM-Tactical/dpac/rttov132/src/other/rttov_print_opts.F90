...
!INTF_END
  ...
  WRITE(iu,'(2x,a,l1)')     "opdep13_gas_clip        ", opts%config%opdep13_gas_clip
  ...
  WRITE(iu,'(2x,a,l1)')     "use_tskin_eff           ", opts%rt_all%use_tskin_eff
  ...
  WRITE(iu,'(2x,a,l1)')     "transmittances_only     ", opts%rt_all%transmittances_only
  WRITE(iu,'(a)',advance='yes')
  ...
  IF (opts%rt_ir%addsolar) THEN
    ...
    WRITE(iu,'(2x,a,l1)')     "rayleigh_depol          ", opts%rt_ir%rayleigh_depol
  ENDIF
  ...
  WRITE(iu,'(2x,a,l1)')     "fastem3_rwd_fix         ", opts%rt_mw%fastem3_rwd_fix
