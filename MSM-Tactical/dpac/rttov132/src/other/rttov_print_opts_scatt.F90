...
!INTF_END
  ...
  WRITE(iu,'(2x,a,l1)')     "opdep13_gas_clip      ", opts_scatt%config%opdep13_gas_clip
  ...
  WRITE(tmp_text,'(i3)') opts_scatt%pol_mode
  WRITE(iu,'(2x,a,a)')      "pol_mode              ", TRIM(ADJUSTL(tmp_text))
  ...
  WRITE(iu,'(2x,a,l1)')     "use_tskin_eff         ", opts_scatt%use_tskin_eff
  ...
  WRITE(iu,'(2x,a,l1)')     "fastem3_rwd_fix       ", opts_scatt%fastem3_rwd_fix
