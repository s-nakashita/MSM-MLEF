...
!!   any channels are solar-enabled (applies to v13 and v9 predictor coef
!!   files) then phase functions will be stored for these channels unless the
...
!!   case of solar-enabled channels in v13/9 predictor files). Therefore you
!!   can use the same aerosol file with v13/7/8/9 IASI coefficients on 54L or
!!   101L for non-solar calculations. If you want to include solar radiation you
!!   would need to generate an aerosol file using a v13/9 predictor IASI file.
!!
...
!!   > --rtcoef_file rtcoef_rttov13/rttov13pred54L/rtcoef_msg_3_seviri_o3co2.dat \
