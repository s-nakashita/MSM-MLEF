...
!* Subroutine arguments:
  ...
  Type (rttov_emissivity),          Intent (in)    :: emissivity_tl(:)              ! Emissivity data structure
...
#include "rttov_errorreport.interface"
  ...
  do ichan = 1, nchannels
    ...
    scatt_aux_tl % tsfc (ichan)          = emissivity_tl (ichan) % tskin_eff
