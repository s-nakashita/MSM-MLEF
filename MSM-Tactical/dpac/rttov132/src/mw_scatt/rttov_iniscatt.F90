...
Subroutine rttov_iniscatt (&
  ...
  !   1.14   06/2022   Adapted for polarised scattering (V. Barlakas)
  !  
  ! Code Description:
  !   Language:           Fortran 90.
...
!* Subroutine arguments:
  ...
  Type (rttov_scatt_coef),          Intent (in)    :: coef_scatt               ! RTTOV-SCATT Coefficients
...
#include "rttov_errorreport.interface"
  ...
  if (lhook) call dr_hook('RTTOV_INISCATT',0_jpim,zhook_handle)
