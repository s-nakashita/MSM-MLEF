...
do i_proma = 1, kproma
  ...
  do i_lev = 1, kflevg
    ...
    read (ioin,'(9e10.3)') &
      ...
      & cld_profiles_d1 (i_proma) % hydro (i_lev,hydro_index_clw),  & ! liquid water   (kg/kg)
      & cld_profiles_d1 (i_proma) % hydro (i_lev,hydro_index_ciw),  & ! ice water      (kg/kg)
      & cld_profiles_d1 (i_proma) % hydro (i_lev,hydro_index_rain), & ! rain           (kg/kg)
      & cld_profiles_d1 (i_proma) % hydro (i_lev,hydro_index_snow)    ! frozen precip. (kg/kg)

    ! Graupel (kg/kg) not yet provided in data file
    cld_profiles_d1 (i_proma) % hydro (i_lev,hydro_index_graupel) = 0.0_JPRB  
