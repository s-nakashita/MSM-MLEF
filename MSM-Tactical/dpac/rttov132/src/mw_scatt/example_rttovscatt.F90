...
do iprof = 1, nprof
  ...
  do ilev = 1,nlev
    ...
    read (fin,'(9e10.3)') &
      ...
      & cld_profiles (iprof) % hydro (ilev,hydro_index_clw),  & ! liquid water   (kg/kg)
      & cld_profiles (iprof) % hydro (ilev,hydro_index_ciw),  & ! ice water      (kg/kg)
      & cld_profiles (iprof) % hydro (ilev,hydro_index_rain), & ! rain           (kg/kg)
      & cld_profiles (iprof) % hydro (ilev,hydro_index_snow)    ! frozen precip. (kg/kg)
