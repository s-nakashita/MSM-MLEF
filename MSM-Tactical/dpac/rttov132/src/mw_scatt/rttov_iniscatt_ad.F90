...
!* Subroutine arguments:
  ...
  Logical (Kind=jplm), Intent (in) :: lthermal    (nchannels) ! Channel active flags
  ...
  Type (rttov_emissivity),          Intent (in)    :: emissivity(:)                 ! Emissivity data structure
  Type (rttov_emissivity),          Intent (inout) :: emissivity_ad(:)              ! Emissivity data structure
...
#include "rttov_calcemis_mw_k.interface"
  ...
  do ichan = 1, nchannels
    ...
    scatt_aux % tsfc (ichan)          = emissivity (ichan) % tskin_eff
...
!* Cloud/rain absorption/scattering parameters
  ...
  do ichan = 1, nchannels
    ...
    emissivity_ad (ichan) % tskin_eff = emissivity_ad (ichan) % tskin_eff + scatt_aux_ad % tsfc (ichan) 
