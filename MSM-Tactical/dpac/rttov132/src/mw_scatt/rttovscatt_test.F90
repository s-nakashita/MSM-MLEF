...
use rttov_const, only : pol_mode_aro_scaled, errorstatus_success
...
if (errorstatus /= errorstatus_success) stop
...
! Test with new polarisation active (v13.2 option, ARO-scaled optical properties)
opts_scatt%lusercfrac = .FALSE._jplm
opts_scatt%pol_mode = pol_mode_aro_scaled

! re-read coefs with the pol_mode_aro_scaled option active to get the scaling table
