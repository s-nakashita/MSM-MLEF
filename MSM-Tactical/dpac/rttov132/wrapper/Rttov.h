...
public:
    ...
    const std::string& getFileCoef() const;
    const std::string& getFileSccld() const;
    const std::string& getFileScaer() const;
    const std::string& getFileMfasisCld() const;
    const std::string& getFileMfasisNN() const;

    void setFileCoef(const std::string& fileCoef);
    void setFileSccld(const std::string& fileSccld);
    void setFileScaer(const std::string& fileScaer);
    void setFileMfasisCld(const std::string& fileMfasisCld);
    void setFileMfasisNN(const std::string& fileMfasisNN);

    void loadInst(); // load instrument for all channels
    void loadInst(const std::vector<int>& channels);
    int getInstId() const;
    ...
    void runDirect(const std::vector<int>& channels);
    void runK() ;
    void runK(const std::vector<int>& channels);
...
protected :
    ...
    double * surfemisrefl;//[5][nprofiles][nchannels];  // Input/output surface emissivities and BRDFs, spec, tskin eff
    ...
    std::string file_coef;
    std::string file_sccld;
    std::string file_scaer;
    std::string file_mfasis_cld;
    std::string file_mfasis_nn;
    std::string file_pccoef;
    std::string file_hydrotable;
    ...
    double * surfemisrefl_k; //[5][nprofiles][nchannels]
