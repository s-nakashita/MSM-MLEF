...
#ifndef RTTOV_ATLAS_H_
#define RTTOV_ATLAS_H_
...
public:
    ...
    void setAtlasPath(const std::string& atlasPath);
    ...
    void fillEmisBrdf(double * emisBrdf, rttov::Rttov * rttov, const std::vector<int>& channels=std::vector<int>{});
    void fillEmisBrdf(double * emisBrdf, rttov::RttovSafe * rttov, const std::vector<int>& channels=std::vector<int>{});
    void fillEmisBrdf(double * emisBrdf, rttov::RttovScatt * rttov, const std::vector<int>& channels=std::vector<int>{});
    void fillEmisBrdf(double * emisBrdf, rttov::RttovScattSafe * rttov, const std::vector<int>& channels=std::vector<int>{});
