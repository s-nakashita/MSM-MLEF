...
(TESSEM2, FASTEM1, FASTEM2, FASTEM3, FASTEM4, FASTEM5, FASTEM6, SURFEM_OCEAN) = range(0, 8)
(ISEM, IREMIS) = range(1, 3)
(JONSWAP, ELFOUHAILY) = range(1, 3)
(MAXRANDOM_OVERLAP, SIMPLE_OVERLAP) = range(1, 3)
(DOM_IR, CHOU) = range(1, 3)
(DOM_VIS, SINGLESCATT, MFASIS, MFASIS_NN) = range(1, 5)
(LIEBE, ROSENKRANZ, TKC) = range(1, 4)
(NO_POL, EMPIRICAL_POL, ARO_SCALED_POL) = range(0, 3)
