...
public:
    ...
    const std::string& getFileHydrotable() const;
    const std::string& getFilePol() const;

    void setFileCoef(const std::string& fileCoef);
    void setFileHydrotable(const std::string& fileHydrotable);
    void setFilePol(const std::string& filePol);
...
protected :
    ...
    double * surfemis;//[2][nprofiles][nchannels];      // Input/output surface emissivities, tskin eff
    ...
    double * surfemis_k; //[2][nprofiles][nchannels]
