...
import pyrttov
import example_data_rttovscatt as ex
...
if __name__ == '__main__':
    ...
    surfemis_amsua = np.zeros((2,nprofiles,nchan_amsua), dtype=np.float64)
    ...
    try:
        surfemis_amsua[0,:,:] = mwAtlas.getEmisBrdf(amsuaRttov)
    except pyrttov.RttovError as e:
