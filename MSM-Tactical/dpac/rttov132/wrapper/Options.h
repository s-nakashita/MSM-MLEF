...
#ifndef RTTOV_OPTIONS_H_
#define RTTOV_OPTIONS_H_
...
enum fastemType {tessem2=0,fastem1,fastem2,fastem3,fastem4,fastem5,fastem6,surfem_ocean};
...
enum visscattmodelType{dom_vis=1,singlescatt,mfasis,mfasis_nn};
enum mwclwschemeType{liebe=1,rosenkranz,tkc};
enum polmode{no_pol=0,empirical_pol,aro_scaled_pol};
...
public:
    ...
    void setFastem3RwdFix(bool fastem3RwdFix);
