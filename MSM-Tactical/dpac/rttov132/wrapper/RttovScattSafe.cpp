...
const std::string& RttovScattSafe::getFileCoef() const {
...
void RttovScattSafe::setFileCoef(const std::string& fileCoef) {
    RttovScatt::setFileCoef(fileCoef);
}

///@brief Return the hydrotable filename
const std::string& RttovScattSafe::getFileHydrotable() const {
...
void RttovScattSafe::setFileHydrotable(const std::string& fileHydrotable) {
    RttovScatt::setFileHydrotable(fileHydrotable);
}

///@brief Return the pol filename
const std::string& RttovScattSafe::getFilePol() const {
    return RttovScatt::getFilePol();
}

///@brief Set the pol filename
///@param filePol string containing full path to pol file
void RttovScattSafe::setFilePol(const std::string& filePol) {
    RttovScatt::setFilePol(filePol);
}
...
///@brief Set pointer to array containing input/output surface emissivity, tskin eff values;
...
void RttovScattSafe::runDirect(const std::vector<int>& channels) {
...
///@param channels vector containing the list of channels to simulate
void RttovScattSafe::runK(const std::vector<int>& channels) {
...
///@param profile index of the profile (0..nprofiles-1)
std::vector<double> RttovScattSafe::getTskinEffK(int profile) {
    return RttovScatt::getTskinEffK(profile);
}
