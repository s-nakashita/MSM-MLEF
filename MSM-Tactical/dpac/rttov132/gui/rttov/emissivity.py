...
class Emissivity(dict, _V):
    ...
    """
    emissivity_list = ['EMIS_IN', 'EMIS_OUT',
                       'SPECULARITY', 'CALCEMIS', 'TSKIN_EFF']
    ...
    def setEmissivity(self, nchannels):
        ...
        self['CALCEMIS'][:] = True
        self['TSKIN_EFF'] = numpy.zeros(nchannels)
        self['TSKIN_EFF_ATTRIBUTE']['LBOUND'] = 1
        self['TSKIN_EFF_ATTRIBUTE']['UBOUND'] = nchannels
...
if __name__ == '__main__':
    ...
    # Display option
    print("\n \n e1 read insurface.H5 ")
    e1.display()
    print("\n")
    print("\n \n r1 read in surface.H5 ")
    r1.display()
    print("\n")
