...
class R1dvarView(util.GenericView):
    ...
    def _CreateEntry(self):
        ...
        btnsizer1.Add(self.btnOpen, 0, wx.GROW | wx.RIGHT | wx.TOP, 5)
        self.sizer.Add(btnsizer1, 0, wx.ALL | wx.EXPAND, 5)
        ...
        self.sizer.Add(slidSizer, 0, wx.ALL | wx.EXPAND, 5)
        ...
        btnsizer2.Add(self.btnStep, flag=wx.RIGHT, border=10)

        self.btnReset = wx.Button(self.panel1, label="Reset")
        self.btnReset.SetHelpText("Reset the 1dvar Project")
        self.btnReset.SetDefault()

        btnsizer2.Add(self.btnReset, flag=wx.RIGHT, border=10)

        self.sizer.Add(btnsizer2, 0, wx.ALL | wx.EXPAND, 5)
    ...
    def OnOpenTrueProfile(self, e):
        ...
        return self.OnOpenFile(e, self.profileDirName,
                               "Open a true profile")
