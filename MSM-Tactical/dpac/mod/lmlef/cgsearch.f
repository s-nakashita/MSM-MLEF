...
C
     ...
     *           STPMIN,STPMAX,MAXFEV,INFO,NFEV,WA,DGINIT,DGOUT)
      ...
      DOUBLE PRECISION, INTENT(INOUT) :: F,STP,DGINIT
      DOUBLE PRECISION, INTENT(IN) :: FTOL,GTOL,XTOL,STPMIN,STPMAX
      DOUBLE PRECISION, INTENT(INOUT) :: X(N),G(N)
      DOUBLE PRECISION, INTENT(INOUT) :: S(N),WA(N)
...
C     **********
      ...
      DOUBLE PRECISION DG,DGM,DGTEST,DGX,DGXM,DGY,DGYM,
...
C
     ...
     *    .OR. STPMAX .LT. STPMIN .OR. MAXFEV .LE. 0) THEN
      WRITE(6,6) N, STP, FTOL, GTOL, XTOL, STPMIN, STPMAX, MAXFEV
   6  FORMAT('N=',I5,X,'STP=',1PD10.3,X,'FTOL=',1PD10.3,X,
